      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            <Heading style={h1}>New Campaign Quote Request</Heading>
            <Text style={subtitle}>
              High-value advertising opportunity from {company}
            </Text>

            {/* Priority Badge */}
            <Section style={prioritySection}>
              <div style={priorityBadge}>
                <Text style={priorityText}>🌟 High-Value Lead</Text>
              </div>
            </Section>
            ...
            <Section style={requirementsCard}>
              <Text style={cardTitle}>Campaign Requirements</Text>
            ...
            <Section style={messageCard}>
              <Text style={cardTitle}>Campaign Goals & Objectives</Text>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              PowerDon Advertising Team • Premium Charging Solutions
            </Text>
...
export default QuoteNotificationTemplate;
...
const prioritySection: CSSProperties = {
  textAlign: "center",
  marginBottom: "24px",
};
...
const priorityText: CSSProperties = {
  color: "#92400e",
  fontSize: "14px",
  fontWeight: "600",
  margin: "0",
