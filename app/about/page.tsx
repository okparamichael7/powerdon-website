    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 mt-20">
          <div className="max-w-4xl">
            <p className="text-2xl text-black leading-relaxed lg:text-4xl tracking-[-0.015em] font-light">
              We eliminate the anxiety of dead batteries by providing reliable, accessible, and fast charging solutions
              in the places where people gather, work, and play. We believe staying connected should not be a luxury. It
              should be effortless and available at any point.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="bg-white border border-gray-200 overflow-hidden shadow-lg">
              <CardContent className="p-0">
                <div className="w-full h-48 mb-6">
                  <img src="/images/innovation-icon.png" alt="Innovation" className="w-full h-full object-cover" />
                </div>
                <div className="px-6 pb-6">
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed leading-[1.20rem]">
                    We continuously push the boundaries of charging technology to deliver faster, more efficient
                    solutions.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="bg-white border border-gray-200 overflow-hidden shadow-lg">
              <CardContent className="p-0">
                ...
                <div className="px-6 pb-6">
                  <h3 className="text-xl font-semibold mb-3 text-black">Sustainability</h3>
                  <p className="text-gray-500 text-sm leading-relaxed leading-[1.20rem]">
                    Our stations use renewable energy sources and promote device longevity through proper charging
                    practices.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="bg-white border border-gray-200 overflow-hidden shadow-lg">
              <CardContent className="p-0">
                <div className="w-full h-48 mb-6">
                  <img src="/images/community-icon.png" alt="Community" className="w-full h-full object-cover" />
                </div>
                <div className="px-6 pb-6">
                  <h3 className="text-xl font-semibold mb-3 text-black">Community</h3>
                  <p className="text-gray-500 text-sm leading-relaxed leading-[1.20rem]">
                    We build connections between people, brands, and communities through our shared charging network.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border border-gray-200 overflow-hidden shadow-lg">
              <CardContent className="p-0">
                <div className="w-full h-48 mb-6">
                  <img src="/images/excellence-icon.png" alt="Excellence" className="w-full h-full object-cover" />
                </div>
                <div className="px-6 pb-6">
                  <h3 className="text-xl font-semibold mb-3 text-black">Excellence</h3>
                  <p className="text-gray-500 text-sm leading-relaxed leading-[1.20rem]">
                    We maintain the highest standards in product quality, customer service, and user experience.
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 mb-20">
          <div className="max-w-4xl">
            <h2 className="text-4xl font-light text-black mb-6">Ready to power your next event?</h2>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl">
              Join thousands of event organizers and brands who trust PowerDon to keep their audiences connected and
              engaged.
            </p>
